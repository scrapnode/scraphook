...
func (x *WebhookSaveRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebhookSaveRes) ProtoMessage() {}

func (x *WebhookSaveRes) ProtoReflect() protoreflect.Message {
	mi := &file_webhook_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebhookSaveRes.ProtoReflect.Descriptor instead.
func (*WebhookSaveRes) Descriptor() ([]byte, []int) {
	return file_webhook_proto_rawDescGZIP(), []int{1}
}

func (x *WebhookSaveRes) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *WebhookSaveRes) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *WebhookSaveRes) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *WebhookSaveRes) GetTokens() []string {
	if x != nil {
		return x.Tokens
	}
	return nil
...
type WebhookGetRes struct {
	...
	Webhook *WebhookRecord `protobuf:"bytes,1,opt,name=webhook,proto3" json:"webhook,omitempty"`
}

func (x *WebhookGetRes) Reset() {
	*x = WebhookGetRes{}
	if protoimpl.UnsafeEnabled {
...
func (x *WebhookGetRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebhookGetRes) ProtoMessage() {}

func (x *WebhookGetRes) ProtoReflect() protoreflect.Message {
	mi := &file_webhook_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebhookGetRes.ProtoReflect.Descriptor instead.
func (*WebhookGetRes) Descriptor() ([]byte, []int) {
	return file_webhook_proto_rawDescGZIP(), []int{5}
}

func (x *WebhookGetRes) GetWebhook() *WebhookRecord {
	if x != nil {
		return x.Webhook
	}
	return nil
...
var file_webhook_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x76, 0x0a, 0x0e, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x53,
	0x61, 0x76, 0x65, 0x52, 0x65, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x22, 0xde, 0x01, 0x0a,
	0x0d, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x21,
	...
	0x64, 0x41, 0x74, 0x12, 0x48, 0x0a, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x06, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x73, 0x63, 0x72, 0x61, 0x70, 0x68, 0x6f, 0x6f, 0x6b, 0x2e,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e,
	0x76, 0x31, 0x2e, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x22, 0x78, 0x0a,
	...
	0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x1f, 0x0a, 0x0d, 0x57, 0x65, 0x62, 0x68, 0x6f,
	0x6f, 0x6b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x56, 0x0a, 0x0d, 0x57, 0x65, 0x62, 0x68,
	0x6f, 0x6f, 0x6b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x12, 0x45, 0x0a, 0x07, 0x77, 0x65, 0x62,
	0x68, 0x6f, 0x6f, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x73, 0x63, 0x72,
	...
	0x6b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x07, 0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b,
	...
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x32, 0xa4, 0x03, 0x0a, 0x07, 0x57, 0x65,
	0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x12, 0x64, 0x0a, 0x04, 0x53, 0x61, 0x76, 0x65, 0x12, 0x2c, 0x2e,
	...
	0x68, 0x6f, 0x6f, 0x6b, 0x53, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x2c, 0x2e, 0x73, 0x63,
	...
	0x6f, 0x6b, 0x53, 0x61, 0x76, 0x65, 0x52, 0x65, 0x73, 0x22, 0x00, 0x12, 0x61, 0x0a, 0x03, 0x47,
	0x65, 0x74, 0x12, 0x2b, 0x2e, 0x73, 0x63, 0x72, 0x61, 0x70, 0x68, 0x6f, 0x6f, 0x6b, 0x2e, 0x61,
	0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x76,
	0x31, 0x2e, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x1a,
	...
	,
...
var file_webhook_proto_goTypes = []interface{}{
	...
	(*WebhookSaveRes)(nil),     // 1: scraphook.admin.dashboard.v1.WebhookSaveRes
	(*WebhookRecord)(nil),      // 2: scraphook.admin.dashboard.v1.WebhookRecord
	(*WebhookTokenRecord)(nil), // 3: scraphook.admin.dashboard.v1.WebhookTokenRecord
	(*WebhookGetReq)(nil),      // 4: scraphook.admin.dashboard.v1.WebhookGetReq
	(*WebhookGetRes)(nil),      // 5: scraphook.admin.dashboard.v1.WebhookGetRes
	(*WebhookListReq)(nil),     // 6: scraphook.admin.dashboard.v1.WebhookListReq
	(*WebhookListRes)(nil),     // 7: scraphook.admin.dashboard.v1.WebhookListRes
	(*WebhookDeleteReq)(nil),   // 8: scraphook.admin.dashboard.v1.WebhookDeleteReq
	(*WebhookDeleteRes)(nil),   // 9: scraphook.admin.dashboard.v1.WebhookDeleteRes
}
var file_webhook_proto_depIdxs = []int32{
	3, // 0: scraphook.admin.dashboard.v1.WebhookRecord.tokens:type_name -> scraphook.admin.dashboard.v1.WebhookTokenRecord
	2, // 1: scraphook.admin.dashboard.v1.WebhookGetRes.webhook:type_name -> scraphook.admin.dashboard.v1.WebhookRecord
	2, // 2: scraphook.admin.dashboard.v1.WebhookListRes.data:type_name -> scraphook.admin.dashboard.v1.WebhookRecord
	0, // 3: scraphook.admin.dashboard.v1.Webhook.Save:input_type -> scraphook.admin.dashboard.v1.WebhookSaveReq
	4, // 4: scraphook.admin.dashboard.v1.Webhook.Get:input_type -> scraphook.admin.dashboard.v1.WebhookGetReq
	6, // 5: scraphook.admin.dashboard.v1.Webhook.List:input_type -> scraphook.admin.dashboard.v1.WebhookListReq
	8, // 6: scraphook.admin.dashboard.v1.Webhook.Delete:input_type -> scraphook.admin.dashboard.v1.WebhookDeleteReq
	1, // 7: scraphook.admin.dashboard.v1.Webhook.Save:output_type -> scraphook.admin.dashboard.v1.WebhookSaveRes
	5, // 8: scraphook.admin.dashboard.v1.Webhook.Get:output_type -> scraphook.admin.dashboard.v1.WebhookGetRes
	7, // 9: scraphook.admin.dashboard.v1.Webhook.List:output_type -> scraphook.admin.dashboard.v1.WebhookListRes
	9, // 10: scraphook.admin.dashboard.v1.Webhook.Delete:output_type -> scraphook.admin.dashboard.v1.WebhookDeleteRes
