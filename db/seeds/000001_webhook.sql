...
INSERT INTO endpoints (workspace_id, webhook_id, id, name, uri, created_at, updated_at) VALUES ('ws_default', 'wh_demo', 'ep_httpbinput','httpbin.org PUT', 'https://httpbin.org/put', 1645488000000000000, 0);
...
INSERT INTO endpoint_rules (endpoint_id, id, rule, negative, priority, created_at, updated_at) VALUES ('ep_httpbinput', 'epr_scheduleput', 'regex::wh_demo' , FALSE, 0, 1645488000000000000, 0);